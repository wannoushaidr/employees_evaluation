...
def draw_boxes(img, bbox, identities=None, categories=None, confidences=None, colors=None, time_spent=None, opt=None, names=None):  
    ...
    return img, centers, temporary_ids
...
#****************************************************************************************************************************************************
                        ...
                        img, centers,a = draw_boxes(im0, bbox_xyxy, identities, categories, confidences=None, colors=colors, time_spent=time_spent, opt=opt, names=names)  
