...
#to take one frame in each 20 frame in viseo
        ...
        # Only process every 20th frame for video  
        ...
        # Draw lines between centers and label distances  
            for m in range(len(centers)):  
                for n in range(m + 1, len(centers)):  
                    ...
                    cv2.line(im0, (int(center1[0]), int(center1[1])), (int(center2[0]), int(center2[1])), (255, 255, 255), 1)  
                    ...
                    if 0 <= mid_x < im0.shape[1] and 0 <= mid_y < im0.shape[0]:  
                        ...
                        distance = float(distance)  # Make sure distance is float for formatting  
                        # Put the distance text on the midpoint  
                        cv2.putText(im0, f"{distance:.2f}", (int(mid_x), int(mid_y)),   cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1)  
                    else:  
...
if __name__ == '__main__':
  ...
  #  parser.add_argument('--source', type=str, default='inference/images', help='source')  # file/folder, 0 for webcam
    #for test image path
    parser.add_argument('--source', type=str, default='4_.jpg', help='source')  # file/folder, 0 for webcam
